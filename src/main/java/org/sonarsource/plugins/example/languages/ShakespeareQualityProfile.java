...
import static org.sonarsource.plugins.example.sensors.ShakespeareRulesDefinition.REPO_KEY;

/**
 * Default, BuiltIn Quality Profile for the projects having files of the language "shakespeare"
 */
public final class ShakespeareQualityProfile implements BuiltInQualityProfilesDefinition {
